...
def get_pose(image):
    result, pose_data = detector(image, only_eye=True)
...
#  python align_pose.py --align ../data/align_images/ali1.jpg --ref ../data/images/bear.jpg --input ../data/videos/ali1.mp4 --output ../output/tmp/poseali.mp4

# python align_pose.py --align ../data/align_images/ali1.jpg --ref ../data/images/bear.jpg --input ../data/frames/ali1/0017.jpg --output tmp.jpg